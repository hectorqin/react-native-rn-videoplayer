    ...
    if (props.showLockCont) {
      return (
        ...
        >
          ...
          >
            {lock ? (
              <SvgVideoLocking width="28" height="28" />
            ) : (
              <SvgVideoUnlock width="30" height="30" />
            )}
          </TouchableOpacity>
        </Animated.View>
      );
...
export const TipsPaused = (props) => {
  ...
  if (show) {
    return (
      <Animated.View
        style={[
          styles.TipsPausedBox,
          {
            opacity: animater,
            left: props.width / 2 - 37,
            top: props.height / 2 - 15,
          },
        ]}
      >
      ...
      >
        ...
        >
          ...
          >
            <Animated.View
              style={{
                backgroundColor: "#ea7a99",
                width: brightnessWidth && brightnessWidth,
                zIndex: 99999,
                height: 2,
              }}
            ></Animated.View>
  ...
  render() {
    ...
    return (
      ...
      >
        ...
        >
          {soundWidth > 0 ? (
            <SvgVideoSound width="20" height="20" />
          ) : (
            <SvgVideoNoSound width="20" height="20" />
          )}
          <View
            style={{
              backgroundColor: "rgba(255,255,255,0.5)",
        ...
        >
          ...
          <Animated.View
            style={{
              zIndex: 12,
              width:
                props.playhideContsDotX === null
                  ? 0
                  : props.admRePlay
                  ? 0
                  : props.playhideContsDotX,
              height: Platform.OS === "android" ? 2 : 3,
              backgroundColor: props.bottomSpeedColor,
            }}
          ></Animated.View>
        </View>
      </View>
  ...
  render() {
    ...
    return (
      ...
      >
        ...
        >
          ...
          <Animated.View
            style={{
              zIndex: 11,
              width:
                props.playBufferX === null
                  ? 0
                  : props.admRePlay
                  ? 0
                  : props.playBufferX,
              height: 2,
              backgroundColor: props.cachColor,
              position: "absolute",
              left: 10,
            }}
          ></Animated.View>
        ...
        <View style={{}}>
          <Text style={{ color: "#ffffff" }}>
            {props.admRePlay ? "00:00" : props.allTime}
          </Text>
        </View>
      </View>
    );
  ...
  render() {
    ...
    return (
      ...
      >
        ...
        >
          <View>
            <Text style={{ color: "#fff" }}>{this.state.goSpeedTime}</Text>
          </View>
          <View>
            <Text style={{ color: "#fff" }}>/</Text>
          </View>
          <View>
            <Text style={{ color: "#fff" }}>{props.allTime}</Text>
          </View>
        </View>
      </View>
    );
